//
//  TrashTalkMessageCellDelegate.swift
//  Tailgate
//
//  Created by Michael Onjack on 7/19/18.
...
public protocol TrashTalkMessageCellDelegate: MessageCellDelegate {
...
public extension TrashTalkMessageCellDelegate {
    func didDoubleTapTopCell(in cell: MessageCollectionViewCell) {}
