    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        if let location:CLLocation = manager.location {
            ...
            if location.horizontalAccuracy < 100 {
                ...
                mapView.addAnnotation( TailgateAnnotation(id:"1", title: "My dope ass tailgate", school: "University of Nebraska", flairImageUrl: "https://firebasestorage.googleapis.com/v0/b/tailgate-53761.appspot.com/o/images%2FStanfordUniversity%2Fflair%2Fflair1.png?alt=media&token=a1f48702-79c2-44e8-9538-25ddd7868dfa", owner: "Michael Onjack", location: loc1) )
