    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        if let location:CLLocation = manager.location {
            ...
            if location.horizontalAccuracy < 100 {
                ...
                mapView.addAnnotation( TailgateAnnotation(id:"1", title: "My dope ass tailgate", school: "University of Nebraska", flairImageUrl: "https://firebasestorage.googleapis.com/v0/b/tailgate-53761.appspot.com/o/images%2FOhioStateUniversity%2FrivalFlair%2Fflair1.png?alt=media&token=d66a3f2f-bcb9-4f7e-ad35-e6f8540c8b24", owner: "Michael Onjack", location: loc1) )
                ...
                mapView.addAnnotation( TailgateAnnotation(id:"3", title: "Tailgate3", school: "Penn State University", flairImageUrl: "https://firebasestorage.googleapis.com/v0/b/tailgate-53761.appspot.com/o/images%2FUniversityofNotreDame%2FrivalFlair%2Fflair1.png?alt=media&token=0ce51126-a33a-410b-9f6e-7f2d50b53588", owner: "Ben Hagan", location: loc3) )
                mapView.addAnnotation( TailgateAnnotation(id:"4", title: "Tailgate4", school: "Ohio State University", flairImageUrl: "https://firebasestorage.googleapis.com/v0/b/tailgate-53761.appspot.com/o/images%2FFloridaStateUniversity%2FrivalFlair%2Fflair1.png?alt=media&token=b48bfb07-8f31-405b-b65b-80d598726975", owner: "Ben Hagan", location: loc4) )
            }
        }
    }
