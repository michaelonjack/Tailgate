    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        if let location:CLLocation = manager.location {
            ...
            if location.horizontalAccuracy < 100 {
                ...
                mapView.addAnnotation( TailgateAnnotation(id:"1", title: "My dope ass tailgate", school: "University of Nebraska", flairImageUrl: "https://firebasestorage.googleapis.com/v0/b/tailgate-53761.appspot.com/o/images%2FDukeUniversity%2Fflair%2Fblah.png?alt=media&token=7042a068-b152-4c54-8043-0e63793243e3", owner: "Michael Onjack", location: loc1) )
